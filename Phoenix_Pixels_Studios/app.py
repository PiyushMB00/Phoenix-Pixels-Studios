...
@app.route("/services/iot-solutions")
def iot_solutions():
    return render_template("services/iot_solutions.html")

@app.route("/services/cloud-infrastructure")
def cloud_infrastructure():
    return render_template("services/cloud_infrastructure.html")

@app.route("/services/technical-consulting")
def technical_consulting():
    return render_template("services/technical_consulting.html")

@app.route("/company/about-us")
def about_us():
...
@app.route("/company/sponsors")
def sponsors():
    return render_template("company/sponsors.html")

@app.route("/company/careers")
def careers():
    return render_template("company/careers.html")

@app.route("/support/privacy-policy")
def privacy_policy():
    return render_template("support/privacy_policy.html")

@app.route("/support/terms-conditions")
